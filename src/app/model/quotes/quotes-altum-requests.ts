...
export class QuotesAltumRequests implements QuotesRequests {

    constructor(private httpClient: HttpClient) {}

    list(params: b2bQuotes.ListRequest) {
        return this.httpClient.get<b2bQuotes.ListResponse>('/api/quotes/listAltum', {params: <any>params});
    }
    ...
    details(id: number): Observable<b2bQuotes.DetailsResponse> {
        return this.httpClient.get<b2bQuotes.DetailsResponse>('/api/quotes/detailsAltum/' + id);
    }
