...
export class PaymentsXlRequests implements PaymentsRequests {

    constructor(private httpClient: HttpClient) { }


    list(params: b2bPayments.ListRequest) {
        return this.httpClient.get<b2bPayments.ListResponse>('/api/payments/listXl', { params: <any>params });
    }
    ...
    details(id: number, type: PaymentType): Observable<b2bPayments.Details> {
        return this.httpClient.get<b2bPayments.DetailsResponse>(`/api/payments/DetailsXl/${id}/${type}`).pipe(map(res => {
