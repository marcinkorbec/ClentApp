...
export class GroupsXlRequests implements GroupsRequests{
    ...
    requestTree(groupId: number, parentId?: number) {
        ...
        return this.httpClient.get<b2bShared.GetTreeResponse>(`/api/items/treeXl/${groupId}?parentId=${convertedParentId}`);
    }
}
