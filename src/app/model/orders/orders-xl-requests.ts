...
export class OrdersXlRequests implements OrdersRequests {

    constructor(private httpClient: HttpClient) { }

    list(params: b2bOrders.ListRequest) {
        return this.httpClient.get<b2bOrders.ListResponse>('/api/orders/listXl', { params: <any>params });
    }
    ...
    details(id: number) {
        return this.httpClient.get<b2bOrders.DetailsResponse>('/api/orders/detailsXl/' + id);
    }
