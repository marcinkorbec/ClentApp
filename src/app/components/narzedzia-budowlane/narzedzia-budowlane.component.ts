...
@Component({
    selector: 'app-narzedzia-budowlane',
    templateUrl: './narzedzia-budowlane.component.html',
    styleUrls: ['./narzedzia-budowlane.component.scss']
})
export class NarzedziaBudowlaneComponent implements OnInit {
