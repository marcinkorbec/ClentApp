...
@Component({
    selector: 'app-odziez-akcesoria-bhp',
    templateUrl: './odziez-akcesoria-bhp.component.html',
    styleUrls: ['./odziez-akcesoria-bhp.component.scss']
})
export class OdziezAkcesoriaBhpComponent implements OnInit {
