...
@Component({
    selector: 'app-kat-techniczne',
    templateUrl: './katalogi-techniczne.component.html',
    styleUrls: ['./katalogi-techniczne.component.scss']
})
export class KatTechniczneComponent implements OnInit {
