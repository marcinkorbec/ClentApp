...
@Component({
    selector: 'app-logo-brandbook',
    templateUrl: './logo-brandbook.component.html',
    styleUrls: ['./logo-brandbook.component.scss']
})
export class LogoBrandbookComponent implements OnInit {
